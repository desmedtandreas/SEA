            ...
            while (aLine != null) {
                ...
                if (aLine != null) {
                    ...
                    if (lineParts.length == 7) {
                        ...
                        instance.setProductVariantId(lineParts[0]);
                        instance.setVatRate(Float.parseFloat(lineParts[1]));
                        instance.setStockQuantity(Float.parseFloat(lineParts[2]));
                        instance.setOrderQuantity(Float.parseFloat(lineParts[3]));
                        instance.setWeight(Float.parseFloat(lineParts[4]));
                        instance.setDimensions(lineParts[5]);
                        instance.setColor(lineParts[6]);
